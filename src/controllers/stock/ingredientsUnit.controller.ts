...
export class IngredientsUnitController {
    ...
    create = catchAsync(async (req: Request, res: Response) => {
        ...
        await auditLogger.log({
            ...
            method: req.method,
            description: `Create ingredient unit ${(ingredientsUnit as any).display_name || (ingredientsUnit as any).id}`,
        });
    ...
    delete = catchAsync(async (req: Request, res: Response) => {
        ...
        return ApiResponses.ok(res, { message: "ลบหน่วยนับวัตถุดิบเรียบร้อย" });
    });
}
