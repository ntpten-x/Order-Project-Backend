...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Orders_1.Orders, (orders) => orders.ordersItems, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: "orders_id" }),
    __metadata("design:type", Orders_1.Orders)
], OrdersItem.prototype, "orders", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: "quantity_ordered", type: "int" }),
    __metadata("design:type", Number)
], OrdersItem.prototype, "quantity_ordered", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => OrdersDetail_1.OrdersDetail, (ordersDetail) => ordersDetail.ordersItem),
    __metadata("design:type", OrdersDetail_1.OrdersDetail)
], OrdersItem.prototype, "ordersDetail", void 0);
