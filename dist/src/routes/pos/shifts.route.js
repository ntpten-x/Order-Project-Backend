...
shiftsRouter.get("/history", auth_middleware_1.authenticateToken, branch_middleware_1.requireBranch, (0, validate_middleware_1.validate)(common_schema_1.paginationQuerySchema), shiftsController.getHistory);
