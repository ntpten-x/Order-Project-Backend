...
CMD="cd ${PROJECT_DIR} && ORDER_RETENTION_ENABLED=true STOCK_ORDER_RETENTION_ENABLED=true AUDIT_LOG_RETENTION_ENABLED=true npm run maintenance:cleanup-orders >> ${LOG_FILE} 2>&1"
